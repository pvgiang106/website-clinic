...
--
-- Host: localhost
-- Generation Time: May 20, 2014 at 01:31 AM
...
(1, 'demo1@email.com', 1, 1, 'Rat hong, ho co dom ', 38, '120/90', '90', 'Viem amidal nang', 'Uong thuoc deu dan hang ngay', 130000),
(2, 'demo2@email.com', 2, 1, 'Rat hong, ho co dom ', 38, '120/90', '90', 'Viem amidal nang', 'Uong thuoc deu dan hang ngay', 130000),
(3, 'demo3@email.com', 1, 1, 'Rat hong, ho co dom ', 38, '120/90', '90', 'Viem amidal nang', 'Uong thuoc deu dan hang ngay', 130000),
(5, 'demo2@email.com', 1, 1, 'asdgasg', 37, '120/80', '90', 'test create', 'abc', 150000),
(8, 'demo1@email.com', 2, 1, 'Symptoms', 37, 'Blood pressure', 'Pulse', 'Diagnosi', 'Advice', 1800000),
(10, 'demo3@email.com', 2, 1, 'gasgdas', 0, 'gasgas', 'asdgas', 'New event', 'gasga', 0);
...
INSERT INTO `lich_kham` (`id_lichkham`, `email`, `li_do_kham`, `id_phongkham`, `ngay_kham`, `thoigian_batdau`, `thoigian_ketthuc`, `status`) VALUES
(1, 'demo1@email.com', 'Kham hong', 1, '2014-05-13', '08:00:00', '09:00:00', 1),
(2, 'demo2@email.com', 'Kham tai', 1, '2014-05-17', '09:00:00', '10:00:00', 1),
(4, 'demo1@email.com', 'Khong tong quat', 2, '2014-05-18', '10:00:00', '11:00:00', 1);
...
(1, '2014-05-17', '10:00:00', '11:00:00', 5, 0),
(1, '2014-05-17', '12:00:00', '13:00:00', 5, 0);
...
(1, 'Tan Binh', 976135377, '127/10 Hoang Hoa Tham', 'Tan Binh', 'Ho Chi Minh', 'Tai Mui Hong', 'www.localhost.com', '2014-04-30', '2014-06-30', 10.7971, 106.647),
(2, 'Phu nhuan', 996926726, '181/30 phan dang luu', 'phu nhuan', 'Ho Chi Minh', 'Rang Ham Mat', 'www.localhost.com', '2014-04-30', '2014-06-30', 10.8005, 106.681),
(3, 'Thu Duc', 932662675, '18 Le Van Chi', 'Thu Duc', 'Ho Chi Minh', 'Rang Ham Mat', 'www.localhost.com', '2014-04-30', '2014-06-30', 0, 0);
